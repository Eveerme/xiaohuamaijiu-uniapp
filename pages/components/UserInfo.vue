<template>
	<view class="wrapper">
		...
		<!-- 统计 -->
		<view class="count">
			<view class="cell"> 8 <text style="color: #AAAAAA;">我的动态</text> </view>
			<view class="cell"> 14 <text style="color: #AAAAAA;">我的点赞</text> </view>
			<view class="cell"> 18 <text style="color: #AAAAAA;">关注商品</text> </view>
			<view class="cell"> 84 <text style="color: #AAAAAA;">已预定商品</text> </view>
		</view>
		<!-- 其它 -->
		<view class="extra">
			<uni-list>
